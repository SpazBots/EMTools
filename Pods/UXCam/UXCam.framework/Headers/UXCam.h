...
//  UXCam.h
//
//  Copyright (c) 2013-2017 UXCam Ltd. All rights reserved.
//
//  UXCam SDK VERSION: 2.5.12
//
...
/**
	...
	@param completionBlock		This block will be called once the app settings have been checked against the UXCam server - the parameter will be TRUE if recording has started. @b NOTE @b: This block is captured and called each time a new session starts.
 */
 ...
 */
+ (void) UploadingPendingSessions:(void (^)(void))block;
